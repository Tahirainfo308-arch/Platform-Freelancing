    ...
    <div className="grid min-h-[calc(100vh-72px)] bg-white lg:grid-cols-[0.9fr_1.1fr]">
      <aside className="relative hidden overflow-hidden bg-[#00501F] p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="relative">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-extrabold uppercase tracking-[0.14em] text-brand-300"><Sparkles className="h-3.5 w-3.5" /> Parwaz membership</span>
        ...
        <div className="relative">
          <div className="max-w-lg rounded-3xl border border-white/10 bg-white/[0.06] p-6 backdrop-blur">
            ...
            <div className="mt-5 flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-brand text-sm font-black">AK</span><div><p className="text-sm font-black">Marketplace member</p><p className="text-xs text-white/40">Verified on Parwaz</p></div><BadgeCheck className="ml-auto h-5 w-5 text-brand-light" /></div>
          </div>
